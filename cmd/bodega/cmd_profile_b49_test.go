...
func TestPinningAPackageNothingRecordsAsAParentSaysSo(t *testing.T) {
	...
	seedVersions(t, env, manifest.TypePypi, "django",
		[]manifest.VersionEntry{{Version: "4.2.11"}})
	seedEdges(t, env,
		manifest.DepEdge{Parent: "git/widget@v4.5.7", Child: "pypi/django@4.2.11", RawSpec: "Django==4.2.11"},
		manifest.DepEdge{Parent: "git/widget@v4.5.7", Child: "pypi/asgiref@3.7.2", RawSpec: "asgiref==3.7.2"},
	)
