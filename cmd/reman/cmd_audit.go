...
Examples:
  ...
  reman audit --type fetch --limit 50            # last 50 fetch events
  reman audit --pkg-type gomod --name github.com/aws/aws-sdk-go-v2
  reman audit --client 10.0.0.5 --since 2026-04-07`,
