// Bootstrap is a CLI tool for managing a centralized S3 reman package
// repository. It supports four artifact types: apt, git, pypi, and binary.
//
// Usage:
//
//	bootstrap [command] [flags]
//	reman shell   # interactive REPL
package main
...
func newRootCmd() *cobra.Command {
	...
	root := &cobra.Command{
		...
		Long: `reman manages a centralized S3 repository of package artifacts:
...
Configuration priority: flags > env vars (REPO_BUCKET, AWS_REGION) > config.json > defaults.`,
	...
	pf.StringVar(&gf.buildRoot, "build-root", "", "Local build directory (default: /opt/repo-manager)")
...
func defaultManifestDir() string {
	...
	// In development, the binary lives in tools/repo-manager/ after
