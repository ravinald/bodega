...
var rssTypes = []struct {
	...
	{manifest.TypeBinary, manifest.BinaryPrefix + "example-vendor/widget-tool/1.7.5/widget-tool.zip", 1 << 20},
	{manifest.TypeGomod, "gomod/example.com/example-corp/widget-sdk/@v/v1.30.0.zip", 1 << 20},
	...
	{manifest.TypeGit, "repos/example-corp--widget/widget-v4.5.5.bundle", 1 << 20},
}
