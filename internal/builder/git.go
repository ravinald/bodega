...
// "example-corp/widget" become "example-corp--widget",
...
// e.g., https://example.com/example-corp/widget.git + v4.5.5
//
//	→ https://example.com/example-corp/widget/archive/refs/tags/v4.5.5.tar.gz
...
func fetchGitRelease(out io.Writer, d dirs, name string, ve manifest.VersionEntry, extractDir string) error {
	...
	// <repo>-<ref>/ (e.g., widget-4.5.5/ without the leading 'v').
